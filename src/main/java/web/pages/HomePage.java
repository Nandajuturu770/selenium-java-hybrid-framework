...
public class HomePage extends WebElementActions {
    ...
    /**
     * @description this method is used to open the sub feature of the home
     * page.
     */
    public void openHomeFeaturesByName(String featureName) {
        ...
        }else if (ProfileFields.THE_SMART_STORE.getProfileFieldName().equals(featureName)) {
            scrollToElementByActions(getTheSmartStoreTitleTxt(), "TheSmartStoreTitleTxt");
            clickByJavaScript(getTheSmartStoreViewAllLnk(), "TheSmartStoreViewAllLnl");
        } else {
        ...
        if (ProfileFields.PROFILE.getProfileFieldName().equals(featureName)) {
            ...
            clickByJavaScript(getLogoutBtn(), featureName); 
        }else {
        ...
        logger.info("system opened \' " + featureName + " \' of the home successfully.\n");
    }
}